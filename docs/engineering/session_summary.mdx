...
Session summary leverages Acontext's [automatic task extraction](/observe/agent_tasks) which runs in the background as your agent converses. The extracted tasks include:
...
Learn how Acontext automatically extracts tasks from conversations.
</Card>
