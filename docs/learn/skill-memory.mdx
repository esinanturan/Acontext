...
description: "Long-term agent memory stored as structured skill files — filesystem-compatible, configurable, and human-readable"
---

Long-term skill is Acontext's approach to persistent agent memory: instead of opaque embeddings or unstructured text, your agents store memory as **skill files** — plain markdown organized by configurable schemas you control.
...
## Long-term Skill — A Different Approach
...
Set up long-term skill for your agent in 3 steps.
</Card>
